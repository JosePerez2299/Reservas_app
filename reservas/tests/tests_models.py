...
#         grupo_mod = Group.objects.get_or_create(name="Moderador")[0]
...
#         """Test validación de espacio disponible"""
...
#         for hora_inicio, hora_fin in casos_solapamiento:
...
#         for hora_inicio, hora_fin in casos_validos:
#             with self.subTest(inicio=hora_inicio, fin=hora_fin):
#                 reserva = Reserva(
#                     usuario=self.usuario,
#                     espacio=self.espacio,
...
# python manage.py test myapp.tests.ReservaModelTest.test_solapamiento_horario_validation
# python manage.py test myapp.tests.ValidateUsernameTest
